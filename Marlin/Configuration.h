...
#define STRING_CONFIG_H_AUTHOR "errorUsernameNotFound" // Original author or contributor.
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp   9.01
    #define DEFAULT_Ki   0.58
    #define DEFAULT_Kd   35.6
  #endif
#else
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 90.20
  #define DEFAULT_bedKi 17.62
  #define DEFAULT_bedKd 307.9
 ...
 * :[2,3,4,5,6,7]
 */
#define ENDSTOP_NOISE_THRESHOLD 6
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 250, 250, 80, 800 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -32.5, 6.5, -2.14 }
